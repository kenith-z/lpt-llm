...
DEFAULT_CONFIG = MemoryEvalConfig()


def build_parser():
    parser = argparse.ArgumentParser(description="运行 LPT v2 xLSTMAssist 专项评测。")
    ...
    parser.add_argument("--checkpoint", type=Path, default=None, help="真实 LPT v2 checkpoint，指定后运行 checkpoint xLSTM 评测。")
