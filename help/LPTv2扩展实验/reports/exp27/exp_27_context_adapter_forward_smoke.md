...
- checkpoint: `artifacts\lpt_v2\experiments_exp27\exp_27_context_adapter\checkpoints\latest\model.pt`
- device: `cuda:0`
- dtype: `float16`
- use_kv_cache: `False`
...
| retnet_q_adapter_delta_norm_mean | 3.909823 |
| retnet_k_adapter_delta_norm_mean | 0.000000 |
| retnet_context_adapter_delta_norm_mean | 11.030073 |
| retnet_alpha_context_mean | -0.00005287 |
| xlstm_state_count | 0 |
