...
- needle_depth: `0.0`
- checkpoint: `artifacts\lpt_v2\experiments_exp26\exp_26_retnet_every_2_layers\checkpoints\latest\model.pt`
- training_stage: `exp_26_retnet_every_2_layers`
- global_step: `1164`

| metric | assist | no_assist | delta |
|---|---:|---:|---:|
| needle_rank | 26333 | n/a | n/a |
| needle_logprob | -24.9569 | n/a | n/a |
