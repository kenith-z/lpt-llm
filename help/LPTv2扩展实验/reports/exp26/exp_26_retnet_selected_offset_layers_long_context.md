...
- needle_depth: `0.0`
- checkpoint: `artifacts\lpt_v2\experiments_exp26\exp_26_retnet_selected_offset_layers\checkpoints\latest\model.pt`
- training_stage: `exp_26_retnet_selected_offset_layers`
- global_step: `1164`

| metric | assist | no_assist | delta |
|---|---:|---:|---:|
| needle_rank | 26069 | n/a | n/a |
| needle_logprob | -24.6965 | n/a | n/a |
