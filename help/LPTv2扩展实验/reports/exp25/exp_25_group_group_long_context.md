...
- needle_depth: `0.0`
- checkpoint: `artifacts\lpt_v2\experiments_exp25\exp_25_group_group\checkpoints\latest\model.pt`
- training_stage: `exp_25_group_group`
- global_step: `1164`

| metric | assist | no_assist | delta |
|---|---:|---:|---:|
| needle_rank | 24956 | n/a | n/a |
| needle_logprob | -23.9029 | n/a | n/a |
