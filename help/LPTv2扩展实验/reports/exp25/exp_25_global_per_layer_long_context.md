...
- needle_depth: `0.0`
- checkpoint: `artifacts\lpt_v2\experiments_exp25\exp_25_global_per_layer\checkpoints\latest\model.pt`
- training_stage: `exp_25_global_per_layer`
- global_step: `1164`

| metric | assist | no_assist | delta |
|---|---:|---:|---:|
| needle_rank | 26855 | n/a | n/a |
| needle_logprob | -25.1180 | n/a | n/a |
